...
import { huggingFaceImageModels, type HuggingFaceImageModel } from "@/lib/ai-image-models";
...
type StudioWorkbenchContextValue = {
  ...
  selectedModel: HuggingFaceImageModel;
...
function useStudioWorkbenchValue({
  ...
  const [selectedModel, setSelectedModel] = useState<HuggingFaceImageModel>(huggingFaceImageModels[0]);
